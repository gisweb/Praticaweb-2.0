...
<?php
utils::loadJS(Array("jquery.easyui.min","locale/easyui-lang-it","searchResultView.$tabpath","init.search.$tabpath","form/ricerca.$tabpath"));
...
<?php include "./inc/inc.page_header.php";?>
    <FORM id="ricerca" name="ricerca" method="post" action="vigi.ricerca.php">
...
if (file_exists(TAB."$tabpath/ricerca_avanzata.tab")){
