...
$(document).ready(function(){
    ...
    $('#btn-report').button({
        ...
        event.preventDefault();
        $('#frm-report').remove();
        $('body').append('<form id="frm-report" action="./services/xReport.php" method="POST" target="reportPraticaweb"><input type="hidden" value="" name="elenco" id="elencopratiche"/><input type="hidden" value="storage" name="application" id="application"/></form>')
    ...
    $('#avvia-ricerca').button({
        ...
        $('#result-table').datagrid({
            ...
            queryParams:{data:dataPost,action:'search',application:'storage',op:oper},
            //view: myview,
