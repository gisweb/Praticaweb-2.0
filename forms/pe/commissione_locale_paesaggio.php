...
$id=$_REQUEST["id"];
$pageTitle="Commissione Locale del Paesaggio - ".$_SESSION["TITOLO_".$idpratica];
?>
<html>
<head>
...
if (($modo=="edit") or ($modo=="new")){
	...
	<?php
		...
		$tabella->set_errors($errors);
		$numrec=$tabella->set_dati("pratica=$idpratica and ente IN (SELECT DISTINCT id FROM pe.e_enti WHERE codice IN ('clp','cei'))");?>
