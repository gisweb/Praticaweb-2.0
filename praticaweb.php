...
if (isset($res[0])) {
	...
	or ($_SESSION["USER_ID"]==52) or ($_SESSION["USER_ID"]==62) or ($_SESSION["USER_ID"]==64) or ($res[0]["resp_proc"]==0))
    {
		...
		<TD id=scan_column vAlign=top align=left width="160px" rowspan="3">
		   ...
		   <!--*** elenco menu *** -->
			...
			/*if ($is_commissione) 
                ...
                //AGGIUNGO FISSO IL MENU PAGAMENTI IN ATTESA DI CAPIRE DOVE SI IMPOSTA LA SESSIONE
                //$menu->add_menu($idpratica,'115');
                //Diego Bertola 07.11.2015
