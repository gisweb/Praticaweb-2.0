...
if ($azione=="Aggiungi"){ 
	...
	if($_SESSION["ADD_NEW"]!==$_POST)
		unset($_SESSION["ADD_NEW"]);//serve vigir non inserire piÃ¹ record con f5
	if (isset($array_dati["errors"])) //sono al ritorno errore
		$Errors=$array_dati["errors"];
	elseif($azione=="Aggiungi")
			//include_once "./db/db.vigi.vincoli.php";
...
function link(id){
	window.location="vigi.scheda_normativa.php?id="+id;
}
	...
	include "./inc/inc.page_header.php";?>
		...
		<TR> 
		  ...
		  <TR> 
			<td> 
				<!-- contenuto-->
				<form method="post" name="vincoli" action="vigi.vincoli.php">
				
				<input type="hidden" name="idriga" id="idriga" value="0">
				<input name="active_form" type="hidden" value="vigi.vincoli.php">
...
//if(NEW_VINCOLI!=1) include_once "db/db.vigi.assegna_vincoli.php";
include_once "./lib/tabella_h.class.php";
