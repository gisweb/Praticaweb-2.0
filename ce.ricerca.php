...
<?php
utils::loadJS(Array("jquery.easyui.min","locale/easyui-lang-it","searchResultView.ce","init.search.ce","form/ricerca.ce"));
...
<?php include "./inc/inc.page_header.php";?>
    <FORM id="ricerca" name="ricerca" method="post" action="ce.ricerca.php">
...
$tabella=new tabella_v("ce/ricerca.tab",'standard');
$tabella->edita();
    /*Ricerca Avanza*/

if (file_exists(TAB."ce/ricerca_avanzata.tab")){
    $tabella_avanzata=new tabella_v("ce/ricerca_avanzata.tab",'standard');
    ob_start();
