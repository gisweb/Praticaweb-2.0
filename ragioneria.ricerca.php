...
<?php
utils::loadJS(Array("jquery.easyui.min","locale/easyui-lang-it","searchResultView","init.search","form/ricerca.ragioneria"));
...
<?php include "./inc/inc.page_header.php";?>
    <FORM id="ricerca" name="ricerca" method="post" action="ragioneria.ricerca.php">
 	<TABLE cellPadding=0  cellspacing=0 border=0 class="stiletabella" width="99%" align="center">		
				  
		  <tr> 
			<td> 
			<!-- intestazione-->
				<H2 class="blueBanner">Ricerca Pagamenti</H2>
			<!-- fine intestazione-->
			</td>
		  </tr>
		  <tr> 
...
$tabella=new tabella_v("ragioneria/ricerca.tab",'standard');
$tabella->edita();
    /*Ricerca Avanza*/

if (file_exists(TAB."ragioneria/ricerca_avanzata.tab")){
    $tabella_avanzata=new tabella_v("ragioneria/ricerca_avanzata.tab",'standard');
    ob_start();
